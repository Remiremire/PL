...
//                    }
//
//                    override fun onFailed(code: Int?, msg: String?, data: String?) {
//                        liveData.value = Resource.failed(code, msg, data)
//                    }
//
//                    override fun onException(code: Int?, msg: String?, cause: Throwable?) {
...
//                    }
//
//                    override fun onFailed(code: Int?, msg: String?, data: Map<String, String>?) {
//                        liveData.value = Resource.failed(code, msg)
//                    }
//
//                    override fun onException(code: Int?, msg: String?, cause: Throwable?) {
//                        liveData.value = Resource.exception(code, msg, cause)
